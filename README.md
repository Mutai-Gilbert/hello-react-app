...
**hello_rails_react** is app build using ruby on rails and react
...
```sh
  cd my-folder
  git@github.com:Mutai-Gilbert/hello-react-app.git
```
...
Feel free to check the [issues page](https://github.com/Mutai-Gilbert/hello-react-app.git).
